...
def Hist_Lab(name):
	...
	epiImg = nib.load('../../../Normalised_Brats_Training_Data/Test/'+name+"_flair.nii.gz") #TODO Change filename as required
	...
	#Loading .nii.gz image
	epiImg = nib.load('../../../Normalised_Brats_Training_Data/Test/seg/'+name[4:]+"_seg.nii.gz") #TODO Change filename as required
	epiImgData = epiImg.get_data()
...
def get_train_names():
	train_names=[]
	for folder in glob.glob('../../../Normalised_Brats_Training_Data/Test/*.gz'):
