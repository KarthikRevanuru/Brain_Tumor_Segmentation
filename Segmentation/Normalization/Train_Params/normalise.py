...
def normalise(name,lm,rm):
	...
	epiImg = nib.load('../../../Brats_Training_Data/Train/'+name+"_flair.nii.gz") #TODO Change filename as required
	...
	#Loading .nii.gz image
	epiImg = nib.load('../../../Brats_Training_Data/Train/'+name+"_t1.nii.gz") #TODO Change filename as required
	epiImgData = epiImg.get_data()
	array=[]
	...
	#Loading .nii.gz image
	epiImg = nib.load('../../../Brats_Training_Data/Train/'+name+"_t1ce.nii.gz") #TODO Change filename as required
	epiImgData = epiImg.get_data()
	array=[]
	...
	#Loading .nii.gz image
	epiImg = nib.load('../../../Brats_Training_Data/Train/'+name+"_t2.nii.gz") #TODO Change filename as required
	epiImgData = epiImg.get_data()
	array=[]
...
def get_train_names():
	train_names=[]
	for folder in glob.glob('../../../Brats_Training_Data/Train/*.gz'):
